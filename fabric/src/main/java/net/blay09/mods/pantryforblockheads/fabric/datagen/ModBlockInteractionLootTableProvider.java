    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        output.accept(BushType.BLUEBERRIES.harvestLootTable(), LootTable.lootTable().withPool(LootPool.lootPool()
                        .add(LootItem.lootTableItem(blueberryBush)
                                ...
                                .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(blueberryBush.asBlock())
        ...
        output.accept(BushType.GRAPES.harvestLootTable(), LootTable.lootTable().withPool(LootPool.lootPool()
                        .add(LootItem.lootTableItem(grapevine)
                                .apply(SetItemCountFunction.setCount(ConstantValue.exactly(1f)))
                                .when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(grapevine.asBlock())
                                        .setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(PantryBushBlock.AGE, PantryBushBlock.MAX_AGE)))))
